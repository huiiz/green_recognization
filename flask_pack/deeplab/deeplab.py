...
from deeplab.utils.utils import resize_image, cvtColor, preprocess_input
from deeplab.nets.deeplabv3_plus import DeepLab

class DeeplabV3(object):
    def __init__(self, path, num, **kwargs):
        self._defaults = {

        "model_path"        : f'{path}/model_data/deeplab_mobilenetv2_{num}.pth',

        "num_classes"       : 2 if num == '1' else 3,
